...
public class Page {
    ...
    public static TGS_UnionExcuseVoid AddMessageToEachPage(String infile, String message, String outfile) {
    ...
    public static TGS_UnionExcuseVoid CreateBlankPDF(String inputFile) {
    ...
    public static TGS_UnionExcuseVoid CreateLandscapePDF(String message, String outfile) {
        try (var doc = new PDDocument()) {
            var font = new PDType1Font(Standard14Fonts.FontName.HELVETICA);
    ...
    public static TGS_UnionExcuseVoid RemoveFirstPage(String filePath) {
        try (var document = Loader.loadPDF(new RandomAccessReadBufferedFile(filePath))) {
            if (document.isEncrypted()) {
                return TGS_UnionExcuseVoid.ofExcuse(Page.class.getSimpleName(), "RemoveFirstPage", "Encrypted documents are not supported for this example");
            }
            if (document.getNumberOfPages() <= 1) {
                return TGS_UnionExcuseVoid.ofExcuse(Page.class.getSimpleName(), "RemoveFirstPage", "Error: A PDF document must have at least one page, cannot remove the last page!");
            }
