...
public class Text {
    ...
    public static TGS_UnionExcuseVoid ShowTextWithPositioning(String message, String outfile, float fontSize_20) {
        // the document
    ...
    public static TGS_UnionExcuseVoid HelloWorld(String message, String filename) {
